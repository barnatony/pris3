...
<head>
    ...
    <meta name="description" content="PRIS, a cloud based HRMS application">
    <meta name="author" content="HRLabz">
    <meta name="keyword" content="HRlabz, PRIS, Payroll, HRMS, VDart, HR, VDSS, VDPL, HR Software">
               ...
               <input type="hidden" name="companyId" id="companyId" value="<?php echo $_GET['companyId']?>">
				...
				<label class="checkbox">
					<span class="pull-right">
						<a data-toggle="modal" id="forgot_pwd" href="#myModal"> <? echo "Vdart....!" ?>Welcome Forgot Password? (IP#13)</a>
                    </span>
				</label>
     ...
     $(document).ready(function () {
         ...
         $('#userLoginForm').on('submit', function (e) {
			...
			/* if($('#check_listener').val()=='not running'){
             $.post('/hr/tcpListenerService.php/?ip=103.92.200.3&port=24456', function() {
                 ...
                 success: function (data) {
                     ...
                     if (data[0] == 'error' ) {
                        ...
                        if(data[2]!='emp')
                        	...
                        	window.location = "../b/redirect/page/?url=dashboard";
                    }
                 }
             });
         });
