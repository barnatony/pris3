	...
	<ul class="sidebar-menu" id="nav-accordion">
		...
		<li class="sub-menu"><a href="javascript:;"> <i class="fa fa-user"></i>
			...
			<ul class="sub">
				...
				<li id="employee"><a href="employees.php">View</a></li>
				...
				<li id="compensation"><a href="../b/redirect/page/?url=attendance/regularization">Regularization Requests</a></li>
				</ul></li>
		<li class="sub-menu"><a href="javascript:;"> <i class="fa fa-exchange"></i> <span>Transactions</span>
			...
			<?php if($features['leaveManagement']['displayUrl']!='leave.php'){ ?>
				...
				<?php }else{ ?>
				<li id="attendances"><a href="<?php echo $features['attendances']['displayUrl'];?>">Attendance</a></li>
				<?php } ?>
		...
		<li class="sub-menu"><a href="javascript:;"> <i class="fa fa-inr"></i>
				<span>Payroll</span>
		</a>
			<ul class="sub">
			<!-- 	<li id="settlement"><a href="settlement.php">Settlement</a></li> -->
				<li id="previewPayroll"><a href="previewPayroll.php">Preview</a></li>
			</ul></li>
